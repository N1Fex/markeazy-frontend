      ...
      try {
        if (isUserValid()) {
          ...
          const currentCart = Array.isArray(res.data)
              ...
              : [];
          const found = currentCart.find(e => e.id == id);
          if (found) {
          ...
          const found = localCart.find(e => e.id === id);
          ...
          <Grid item size={{xs: 12,md: 6}}>
            <Stack spacing={3}>
              ...
              <Stack direction="row" gap={1}>
                ...
                <SellerLegend seller={product.seller}></SellerLegend>
              </Stack>
              ...
              <Box>
                {product.discount > 0 ? (
                    <Stack direction="row" spacing={2} alignItems="baseline">
                      <Typography variant="h3" color={"#287233"} fontWeight="bold">
                        {discountPrice} ₽
                      </Typography>
                      <Typography style={{}}
                          variant="h5"
              ...
              <Stack direction="row" spacing={2} sx={{ mt: 3 }}>
                {
                  inCartAmount !== 0 ?
                      <CounterAmount id={id} value={inCartAmount} setValue={setInCartAmount}
                    ...
                    <Button
                        ...
                        sx={{ flex: 1, py: 1.5 }}
                    >
                      {product.amount > 0 ? 'В корзину' : 'Нет в наличии'}
                    </Button>
                }
